...
modelisation software such as blender for example. The 3D model is stored inside a .obj file.
You should take care of a simple parsing to get the expected result.
...
• Code to the norm and in C : The OpenGL API is in C, get used to it. Some langages overlay
